...
public class CustomerMedicineOrderStatus extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			emailBodyMessage="Hi "+cname+","+System.lineSeparator()+System.lineSeparator()+ "Your Medicine order is '"+mStatus+"' now."+System.lineSeparator()+System.lineSeparator()+"Your Medicine Order Details Is - "+System.lineSeparator()+"Medicine Order No: "+orderNo+System.lineSeparator()+"Medicine Name: "+medcineName + System.lineSeparator()+"Medicine Quantity: "+ medicineQuantity +System.lineSeparator()+"Single Medicine Quantity Price: "+medicineMrp+System.lineSeparator()+"Medicine Total Price. "+medicineTotalPrice+System.lineSeparator()+System.lineSeparator()+"E-Pharmacy System.";
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		try {
			EmailUtility.sendEmail(host, port, "javatestingprojects@gmail.com", "java@1997", email, message,emailBodyMessage);
